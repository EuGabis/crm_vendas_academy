...
import { cn, formatCompactCurrency, formatPercent, dayLabelPt } from '@/lib/utils';
...
export function WorkspaceMeuDia() {
  ...
  const myGoal = useMemo(() => {
    ...
    return { revenueGoal: goal.revenueGoal, revenue, pct: revenue / goal.revenueGoal };
                ...
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-white tabular-nums mt-1">
                      {formatCompactCurrency(myGoal.revenue)}{' '}
                      <span className="text-sm text-zinc-500">de {formatCompactCurrency(myGoal.revenueGoal)}</span>
                    </p>
                  </div>
                  <Badge
                    variant={
