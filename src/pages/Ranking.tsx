...
import { cn, formatCompactCurrency, formatCurrency, formatInt, formatPercent } from '@/lib/utils';
...
export function Ranking() {
  ...
  const ranking = useMemo(
    () => [...getSellerCards({ year, month })].sort((a, b) => b.revenue - a.revenue),
    [year, month],
  );
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2.5">
                          ...
                          <span className="text-zinc-100 font-medium">{row.seller.fullName}</span>
                        </div>
                      </td>
