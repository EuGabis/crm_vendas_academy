...
/**
 * Upsert nativo do PostgREST: INSERT ... ON CONFLICT DO UPDATE.
 * Requer UNIQUE constraint na(s) coluna(s) informadas em onConflict.
 *
 * Resolve o bug de "try UPDATE catch INSERT" — o PATCH nao lanca em 0 rows,
 * entao INSERT nunca rodava pra registros novos.
 */
