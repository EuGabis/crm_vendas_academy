...
function makeDatasets(): Datasets {
  return {
    ...
    goals: [
      { sellerId: 's1', yearMonth: YM, pointsGoal: 0, revenueGoal: 10000, coursesGoal: 10, businessDays: 20 },
      { sellerId: 's2', yearMonth: YM, pointsGoal: 0, revenueGoal: 5000, coursesGoal: 5, businessDays: 20 },
    ],
    sales: [
